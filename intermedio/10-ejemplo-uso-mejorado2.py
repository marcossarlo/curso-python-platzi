...
class EmployeeManager:
    ...
    def export_to_csv(self, file_name: str = "10-employees.csv"):
        """
    ...
    def generate_report(self):
        """Genera un reporte con estadísticas de los empleados."""
        if not self.employees:
            print("No hay empleados registrados para generar un reporte.")
            return
        ...
        position_counts = Counter(employee["position"] for employee in self.employees)
